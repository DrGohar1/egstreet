import { 
  ...
  Brain, Rss, Shield, BarChart3, FileCode
} from "lucide-react";
          ...
          <SidebarMenuItem key={item.url}>
            <SidebarMenuButton asChild>
              <NavLink
                ...
                className="flex items-center gap-3 px-3 py-2 rounded-lg text-sidebar-foreground/70 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground transition-all duration-200 text-sm"
  ...
  return (
    <Sidebar className={`${collapsed ? "w-14" : "w-60"} border-e border-sidebar-border`} collapsible="icon">
      <SidebarContent className="bg-sidebar flex flex-col h-full">
        ...
        {/* Menu */}
        <SidebarGroup className="flex-1 pt-3 px-2 overflow-y-auto">
